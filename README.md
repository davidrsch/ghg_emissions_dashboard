...
## Data Sources
This dashboard uses the 2025 EDGAR GHG dataset published by the Joint Research Centre (JRC) of the European Commission. The dataset includes country-level and sectoral emissions estimates. For more information, visit:
...
> EDGAR 2025 Global Greenhouse Gas Emissions Data, Emissions Database for Global Atmospheric Research (EDGAR), Joint Research Centre (JRC) of the European Commission. [https://edgar.jrc.ec.europa.eu](https://edgar.jrc.ec.europa.eu)
